...
import { createAccount, getUserByCpf, getUserByEmail, getUserByLogin } from '../utils/apiFunctions';
...
const RegisterForm = ({ step, setStep, routeProps }) => {
    ...
    const schemaFields = {
        ...
        complement: {
            ...
            login: Yup.string().required("Campo obrigatório").min(6, "Login menor que seis caracteres")
        },
        contact: {
    ...
    async function onSubmit(values) {
        ...
        const data = {
            name: values.name,
            doc_fiscal: values.cpf,
            email: values.email,
            password: values.password,
            nickname: values.login,
            celular1: mobile1,
            celular2: values?.mobile2,
